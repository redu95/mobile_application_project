...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> checkConnection() async {
    ...
    if (!isConnected) {
      showNoInternetSnackBar(); // Show snackbar if no internet
    }
  }
  ...
  void showNoInternetSnackBar() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        duration: Duration(seconds: 3), // Adjust the duration as desired
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        home: Scaffold(
            body: SafeArea(
              child:  isConnected ? buildHomePage() : Center(child: CircularProgressIndicator()) ,
            ),
        )
    );
  }
