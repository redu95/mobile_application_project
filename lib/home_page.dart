...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> fetchFavorites() async {
    ...
    try {
      ...
      setState(() {
        favoriteHotelIds =
            snapshot.docs.map((doc) => doc['hotelId'] as String).toList();
      });
    } catch (e) {
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        MyBookingsPage()), // Navigate to your bookings page
                              );
                            },
                            child: Icon(
                  ...
                  child: hotels.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            bool isFavorite =
                                favoriteHotelIds.contains(hotel['id']);
                            return InkWell(
                              onTap: () {
                                Navigator.push(
                                  context,
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              ...
                              child: Container(
                                height:
                                    140, // Adjust the height to your desired value
                                margin: EdgeInsets.symmetric(horizontal: 8),
                                width:
                                    350, //adjust the width to your desired value
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(
                                    color: primaryColor,
                                ...
                                child: Row(
                                  children: [
                                    Container(
                                      width:
                                          80, // Adjust the width to your desired value
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.only(
                                          topLeft: Radius.circular(12),
