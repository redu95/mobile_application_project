...
class DataHome{
  ...
  List<Detail> getRoomimg = [
    Detail(
      ...
      "assets/images/hotel_im/hiltonb3.jpg",
      "55",
      "assets/images/hotel_im/hiltonb3.jpg",
      "Standard King Room", // Replace room1name with "Standard King Room"
      "65",
      "assets/images/hotel_im/hiltonb.jpg",
      "Twin Room", // Replace room2name with "Twin Room"
      "99",
      "assets/images/hotel_im/hiltonb.jpg",
      "Superior King Room", // Replace room3name with "Superior King Room"
      "99",
      "assets/images/hotel_im/capitalb2.jpg",
      "Queen Size",
      "88",
      "assets/images/hotel_im/hiltonb3.jpg",
      "Twin Room", // Replace room4name with "Twin Room"
      "55",
      "assets/images/hotel_im/capitalb2.jpg",
      "Double Room", // Replace room5name with "Double Room"
      "82",
      "assets/images/hotel_im/hiltonb3.jpg",
      "Suite", // Replace room6name with "Suite"
      "65",
      "Hilton Hotel",
      "kirskos,Addis Ababa",
    ),
    // Repeat the same modifications for the remaining Detail objects
    Detail(
      "assets/images/hotel_im/sheratonb.jpg",
      "assets/images/hotel_im/sheratonb2.jpeg",
      "assets/images/hotel_im/sheratonb3.jpg",
      "58",
      "assets/images/hotel_im/hiltonb.jpg",
      "Standard King Room",
      "99",
    ...
    Detail(
      ...
      "assets/images/hotel_im/capitalb2.jpg",
      "assets/images/hotel_im/capitalb3.png",
      "90",
      "assets/images/hotel_im/hiltonb3.jpg",
      "Suite",
      "65",
    ...
    Detail(
      ...
      "assets/images/hotel_im/harmonyb2.jpg",
      "assets/images/hotel_im/harmnyb3.jpg",
      "95",
      "assets/images/hotel_im/hiltonb.jpg",
      "Standard King Room",
      "99",
    ...
    Detail(
      ...
      "assets/images/hotel_im/skycb2.jpg",
      "assets/images/hotel_im/skyb3.jpg",
      "79",
      "assets/images/hotel_im/hiltonb.jpg",
      "Standard King Room",
      "99",
      ...
      "65",
      "Sky City Hotel",
      "Aratkilo,Addis Ababa",
    ),
    // Repeat the same modifications for the remaining Detail objects
    Detail(
      "assets/images/hotel_im/Ililib.jpeg",
      "assets/images/hotel_im/ililib2.jpg",
      "assets/images/hotel_im/ililib3.jpg",
      "88",
      "assets/images/hotel_im/hiltonb.jpg",
      "Standard King Room",
      "99",
